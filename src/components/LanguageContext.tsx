...
const translations: Record<Language, Translations> = {
    ...
    ar: {
        app_title: 'أوفيشال',
        tagline: 'الصوت اليقين.. وسط ضجيج العالمين',
        ...
        no_updates: 'لا توجد تحديثات حالياً.. النظام قيد التزامن',
        no_filter_results: 'لم يتم العثور على نتائج لهذا القسم',
        signal_over_noise: 'اليقين وسط الضجيج',
        aggregates_note: 'المصدر الموثق والوحيد لإعلانات كبرى مختبرات الذكاء الاصطناعي العالمية. بلا شائعات، بلا انحياز.. الحقائق كما هي.',
        more: 'تحديثات أخرى',
        updates_badge: 'تحديث',
        hero_line1: 'الصوت اليقين',
        hero_line2: 'وسط ضجيج العالمين',
        official_announcements: 'الإعلانات الرسمية من',
        recent: 'حديثاً',
        tag_Release: 'إصدار جديد',
        tag_News: 'أخبار',
        tag_Research: 'أبحاث',
