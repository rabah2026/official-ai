    ...
    return (
        <div className="container-max py-32 animate-fade-in-up">
            ...
            <div className="space-y-6 max-w-3xl">
                <div className="bg-[var(--color-surface)] border border-[var(--color-border)] p-8 rounded-2xl hover:shadow-md transition-shadow">
                    <h3 className="text-lg font-bold text-[var(--color-foreground)] mb-3">What is Official.ai?</h3>
                ...
                <div className="bg-[var(--color-surface)] border border-[var(--color-border)] p-8 rounded-2xl hover:shadow-md transition-shadow">
                    <h3 className="text-lg font-bold text-[var(--color-foreground)] mb-3">Which sources do you track?</h3>
                    <p className="text-[var(--color-muted-foreground)] leading-relaxed">
                        We currently track official blogs, press releases, and verified social media channels of major AI companies including OpenAI, Google DeepMind, Anthropic, Meta AI, Apple, and others. The list is constantly expanding.
                    </p>
                </div>

                <div className="bg-[var(--color-surface)] border border-[var(--color-border)] p-8 rounded-2xl hover:shadow-md transition-shadow">
                    <h3 className="text-lg font-bold text-[var(--color-foreground)] mb-3">How often is the data updated?</h3>
                    <p className="text-[var(--color-muted-foreground)] leading-relaxed">
                ...
                <div className="bg-[var(--color-surface)] border border-[var(--color-border)] p-8 rounded-2xl hover:shadow-md transition-shadow">
                    <h3 className="text-lg font-bold text-[var(--color-foreground)] mb-3">Is this a free service?</h3>
                    <p className="text-[var(--color-muted-foreground)] leading-relaxed">
